...
class TestUrbanRoutes:
    ...
    def test_set_taxi_and_comfort_rate(self):
        rate_page = methods.UrbanRoutesPage(self.driver)
    ...
    def test_phone_interaction_and_filling(self):
        form_page = methods.UrbanRoutesPage(self.driver)
    ...
    def test_phone_code_confirmation(self):
        phone_form = methods.UrbanRoutesPage(self.driver)
    ...
    def test_card_interactions_and_filling(self):
        card_form = methods.UrbanRoutesPage(self.driver)
    ...
    def test_comments_to_the_driver(self):
        comments_form = methods.UrbanRoutesPage(self.driver)
    ...
    def test_blanket_request(self):
        requests_form = methods.UrbanRoutesPage(self.driver)
    ...
    def test_wait_for_taxi_modal_to_be_displayed(self):
        service_confirmation = methods.UrbanRoutesPage(self.driver)
